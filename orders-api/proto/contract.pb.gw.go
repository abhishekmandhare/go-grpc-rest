...
func RegisterOrdersAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrdersAPIServer) error {
	...
	mux.Handle("POST", pattern_OrdersAPI_CreateOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/server.OrdersAPI/CreateOrder", runtime.WithHTTPPathPattern("/api/Orders"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_OrdersAPI_CreateOrder_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterOrdersAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrdersAPIClient) error {
	...
	mux.Handle("POST", pattern_OrdersAPI_CreateOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/server.OrdersAPI/CreateOrder", runtime.WithHTTPPathPattern("/api/Orders"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_OrdersAPI_CreateOrder_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_OrdersAPI_CreateOrder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "Orders"}, ""))
)
